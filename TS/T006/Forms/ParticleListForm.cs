...
namespace T006.Forms
{
    ...
    /// 粒子列表窗口，显示输出冲突的粒子。
    /// </summary>
    public partial class ParticleListForm : Form
    {
        /// <summary>
        /// 构造函数。
        /// </summary>
        public ParticleListForm()
        {
            InitializeComponent();
        }
        ...
        public static SortedList<String, List<String>> GetOutPutList()
        {
            ...
            GetFolderOutPutList(ProjectManager.Project.ParticleRootFolder, outputlist);
            return outputlist;
        }
        ...
        protected static void GetFolderOutPutList(String folder, SortedList<String, List<String>> outputlist)
        {
            ...
            {
                ParticleFile file = ParticleFile.LoadFromFile(fiTemp.FullName);
                if (file != null)
                {
                    String output = file.EditParticle.ID;
                    String path = fiTemp.FullName.Substring(ProjectManager.Project.ParticleRootFolder.Length + 1);
        ...
        /// 窗体加载。
        /// </summary>
        private void ParticleListForm_Load(object sender, EventArgs e)
        {
