...
namespace T006.Data
{
    ...
    public class ProjectManager
    {
        ...
        /// <param name="iWidth">场景宽度。</param>
        /// <param name="iHeight">场景高度。</param>
        /// <param name="iFPS">编辑时显示的FPS。</param>
        /// <returns>0、创建成功 1、要保存的目录不存在 2、保存目录中存在同名目录 3、其它错误</returns>
        public Int32 CreateNewProject(String strName, String strFolder, Int32 iWidth, Int32 iHeight, Int32 iFPS)
        {
            //判定保存的目录
            ...
            try
            {
                ...
                Directory.CreateDirectory(strProjectFolder + BRANCH_NAME_PARTICLEFOLDER);
                Directory.CreateDirectory(strProjectFolder + BRANCH_NAME_BACKFOLDER);
                ...
                swWriter.WriteLine("Mark=ParticleProject");
                swWriter.WriteLine("SceneWidth=" + iWidth);
                swWriter.WriteLine("SceneHeight=" + iHeight);
                swWriter.WriteLine("ShowFPS=" + iFPS);
                swWriter.Flush();
                fsProject.Flush();
                swWriter.Close();
                swWriter = null;
        ...
        public Int32 OpenProject(String strProjectFile)
        {
            ...
            if (File.Exists(strProjectFile))
            {
                ...
                if (sbBuffer.ToString().Equals("ParticleProject"))
                {
                    //确定为工程文件，读入场景尺寸
                    this.m_strProjectFile = strProjectFile;
                    this.m_iSceneWidth = ReadWriteIni.GetPrivateProfileInt("Project", "SceneWidth", 100, strProjectFile);
                    this.m_iSceneHeight = ReadWriteIni.GetPrivateProfileInt("Project", "SceneHeight", 100, strProjectFile);
                    this.m_iShowFPS = ReadWriteIni.GetPrivateProfileInt("Project", "ShowFPS", 40, strProjectFile);
                    ...
                    ReadWriteIni.GetPrivateProfileString("Config", "ParticleBuild", String.Empty, sbBuffer, 256, cfgf);
                    this.m_strParticleBuildFolder = sbBuffer.ToString();
                }
                else
                {
                    iRet = 2;
        ...
        public Int32 CloseProject()
        {
            ...
            this.m_strParticleBuildFolder = String.Empty;
            return iRet;
        }
        ...
        public Int32 RenameProjectResource(String strFileName, String strNewName, Int32 iType)
        {
            ...
            //判断是什么类型的资源，不同类型不同处理
            if (iType == TYPE_RESOURCE_PARTICLE)
            {
        ...
        public ResourceFile OpenResourceFile(String strFileName, Int32 iType)
        {
            ...
            if (iType == TYPE_RESOURCE_PARTICLE)
            {
                rfEditFile = ParticleFile.LoadFromFile(strFileName);
            }
        ...
        /// 获取粒子的根文件夹路径。
        /// </summary>
        public String ParticleRootFolder
        {
            get
            {
                return this.ProjectFolder + BRANCH_NAME_PARTICLEFOLDER;
            }
        }
        ...
        public String BackFolder
        {
            get
            {
                return this.ProjectFolder + BRANCH_NAME_BACKFOLDER;
            }
        }
        ...
        /// 获取或设置粒子生成的目录。
        /// </summary>
        public String ParticleBuildFolder
        {
            get
            {
                return this.m_strParticleBuildFolder;
            }
            set
            {
                String folder = value.Equals(String.Empty) || value.EndsWith("\\") ? value : value + "\\";
                if (!this.m_strParticleBuildFolder.Equals(folder))
                {
                    String cfgf = Path.GetDirectoryName(this.m_strProjectFile) + NAME_PROJECT_CONFIG;
                    ReadWriteIni.WritePrivateProfileString("Config", "ParticleBuild", folder, cfgf);
                    this.m_strParticleBuildFolder = folder;
                }
            }
        }
        ...
        public Int32 SceneWidth
        {
            ...
            set
            {
                if (value >= 100)
                {
                    ReadWriteIni.WritePrivateProfileString("Project", "SceneWidth", value.ToString(), this.m_strProjectFile);
                    this.m_iSceneWidth = value;
                }
            }
        }
        ...
        public Int32 SceneHeight
        {
            ...
            set
            {
                if (value >= 100)
                {
                    ReadWriteIni.WritePrivateProfileString("Project", "SceneHeight", value.ToString(), this.m_strProjectFile);
                    this.m_iSceneHeight = value;
                }
            }
        }
        ...
        public Int32 ShowFPS
        {
            ...
            set
            {
                if (value >= 10)
                {
                    ReadWriteIni.WritePrivateProfileString("Project", "ShowFPS", value.ToString(), this.m_strProjectFile);
                    this.m_iShowFPS = value;
                }
            }
        }
        ...
        protected void CheckConfigFile()
        {
            ...
            if (!File.Exists(cfgf))
            {
                ...
                swWriter.WriteLine("ParticleBuild=");
                swWriter.Flush();
                fsConfig.Flush();
                swWriter.Close();
                swWriter = null;
        ...
        /// 粒子生成的目录。
        /// </summary>
        private String m_strParticleBuildFolder = String.Empty;

        /// <summary>
        /// 场景宽度。
        /// </summary>
        private Int32 m_iSceneWidth = 0;

        /// <summary>
        /// 场景高度。
        /// </summary>
        private Int32 m_iSceneHeight = 0;

        /// <summary>
        /// 编辑显示的FPS。
        /// </summary>
        private Int32 m_iShowFPS = 0;
        ...
        /// 粒子分支的名称。
        /// </summary>
        public const String BRANCH_NAME_PARTICLE = "粒子";

        /// <summary>
        /// 粒子分支支对应的根文件夹。
        /// </summary>
        public const String BRANCH_NAME_PARTICLEFOLDER = @"\Particle";

        /// <summary>
        /// 背景图对应的根文件夹。
        /// </summary>
        public const String BRANCH_NAME_BACKFOLDER = @"\Back";
        ...
        {
            BRANCH_NAME_PARTICLEFOLDER, 
        };

        /// <summary>
        /// 粒子编辑文件后缀名。
        /// </summary>
        public const String NAME_EXT_PARTICLE_EDIT = ".xml";

        /// <summary>
        /// 粒子生成文件后缀名。
        /// </summary>
        public const String NAME_EXT_PARTICLE_BUILD = ".ps";

        /// <summary>
        /// 工程文件后缀名。
        /// </summary>
        public const String NAME_EXT_PROJECT = ".pp";
        ...
        /// 通过资源类型快速获取其文件后缀名。
        /// </summary>
        public static String[] ResourceFileNameExt = new String[] { NAME_EXT_PARTICLE_EDIT };
        ...
        /// 粒子资源类型。
        /// </summary>
        public const Int32 TYPE_RESOURCE_PARTICLE = 0;
