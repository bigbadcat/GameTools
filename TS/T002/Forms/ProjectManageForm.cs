...
namespace T002.Forms
{
    ...
    public partial class ProjectManageForm : DockContent
    {
        ...
        public void LoadProject(String strProjectFile)
        {
            ...
            //创建界面分支
            TreeNode tnBranch = tnProject.Nodes.Add(ProjectManager.BRANCH_NAME_INTERFACE);
            tnBranch.SelectedImageIndex = tnBranch.ImageIndex = IMG_INDEX_PRM_INTERFACE;
            tnBranch.Tag = MANAGE_TAG_PRM_INTERFACEROOT;
            tnBranch.ContextMenuStrip = this.cmsBranch;

            //加载四种资源
            this.LoadAppointedResource(strProjectFolder, ProjectManager.TYPE_RESOURCE_INTERFACE);
        ...
        /// 界面分支根节点
        /// </summary>
        public TreeNode InterfaceRootNode
        {
            get
            {
        ...
        protected Boolean IsAppointedResource(FileInfo fiFile, Int32 iType)
        {
            ...
            switch (iType)
            {
                case ProjectManager.TYPE_RESOURCE_INTERFACE:
                    {
                        bIsAppointed = strExtName == ProjectManager.NAME_EXT_INTERFACE_EDIT;
                        break;
                    }
                default:
                    {
        ...
        protected Int32 GetBranchTypeFromTag(String strTag)
        {
            ...
            switch (strTag)
            {
                case MANAGE_TAG_PRM_INTERFACEFILE:
                case MANAGE_TAG_PRM_INTERFACEFOLDER:
                case MANAGE_TAG_PRM_INTERFACEROOT:
                    {
                        iNodeType = ProjectManager.TYPE_RESOURCE_INTERFACE;
                        break;
                    }
                default:
                    {
        ...
        /// 界面分支根节点的Tag。
        /// </summary>
        public const String MANAGE_TAG_PRM_INTERFACEROOT = "InterfaceRoot";

        /// <summary>
        /// 界面文件Tag。
        /// </summary>
        public const String MANAGE_TAG_PRM_INTERFACEFILE = "InterfaceFile";

        /// <summary>
        /// 界面文件夹Tag。
        /// </summary>
        public const String MANAGE_TAG_PRM_INTERFACEFOLDER = "InterfaceFolder";
        ...
        {
            MANAGE_TAG_PRM_INTERFACEFOLDER
        };
        ...
        /// 界面分支根节点图像索引。
        /// </summary>
        public const Int32 IMG_INDEX_PRM_INTERFACE = 1;

        /// <summary>
        /// 界面文件节点图像索引。
        /// </summary>
        public const Int32 IMG_INDEX_PRM_INTERFACEFILE = 2;
        ...
        private void cmsResource_Opening(object sender, CancelEventArgs e)
        {
            ...
            if (iNodeType == ProjectManager.TYPE_RESOURCE_INTERFACE)
            {
